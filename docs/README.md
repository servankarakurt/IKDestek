...
- **Aktivite logu:** Giriş/çıkış, şifre değişikliği ve kritik işlemler (izin, çalışan, stajyer) ActivityLogs tablosunda tutulur; denetim ve raporlama için kullanılabilir.
...
- **Veri modeli / ER diyagramı:** [VERI-MODELI-ER-DIYAGRAMI.md](VERI-MODELI-ER-DIYAGRAMI.md) — Tablolar, kolonlar, ilişkiler ve Mermaid ER diyagramı.
